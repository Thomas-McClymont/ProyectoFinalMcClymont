...
class UI {
        ...
        products.forEach(product => {
            ...
            <article class="product">
                <div class="img-container">
                    ...
                    <button class="scart-btn" data-id=${product.id}>
    ...
    getCartButtons(){
        const buttons = [...document.querySelectorAll(".scart-btn")]
        buttonsDOM = buttons
    ...
    showCart(){
        cartOpen.classList.add("transparentBcg")
    ...
    hideCart(){
        cartOpen.classList.remove("transparentBcg")
    ...
    cartLogic(){
        ...
        cartContent.addEventListener('click', event => {
            if(event.target.classList.contains("remove")) {
                ...
                cart.content.removeChild(removeItem.parentElement.parentElement)
                this.removeItem(id)
